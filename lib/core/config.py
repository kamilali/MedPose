...
# Indicates the model uses MedPose for keypoint predictions
__C.MODEL.MEDPOSE_ON = False
...
# MEDPOSE options
# ---------------------------------------------------------------------------- #
__C.MEDPOSE = AttrDict()

__C.MEDPOSE.MODULE_NAME="med_pose_network"
__C.MEDPOSE.NUM_STACKED_CONVS=4
__C.MEDPOSE.HEATMAP_UPSCALE=7
__C.MEDPOSE.MODEL_DIM=256
__C.MEDPOSE.STACK_LAYERS=4
__C.MEDPOSE.WINDOW_SIZE=1
__C.MEDPOSE.NUM_KEYPOINTS = 17
__C.MEDPOSE.ROI_MAP_DIM = 14
