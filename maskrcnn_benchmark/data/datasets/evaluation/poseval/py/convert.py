...
from maskrcnn_benchmark.data.datasets.evaluation.poseval.py.posetrack18_id2fname import posetrack18_fname2id, posetrack18_id2fname
    ...
    def from_new(cls, track_data):
        ...
        for image_id in [image["id"] for image in track_data["images"]]:
            ...
            for person_info in track_data["annotations"]:
                if person_info is None or person_info["image_id"] != image_id:
                    continue
