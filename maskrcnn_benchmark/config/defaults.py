...
_C.MODEL.MEDPOSE_ON = False
_C.MODEL.MEDPOSE_ABLATION = False
_C.MODEL.MEDPOSE_ENCODER_LRCM = True
_C.MODEL.MEDPOSE_DECODER_LRCM = True
_C.MODEL.MEDPOSE_DECODER = False
_C.MODEL.MEDPOSE_SYNC_BATCHNORM = False
...
_C.MODEL.MEDPOSE = CN()
_C.MODEL.MEDPOSE.CONV_LAYERS = tuple(512 for _ in range(7)) + (612,) # 1088 so we can produce a 8 x 8 map (17 x 8 x 8)
_C.MODEL.MEDPOSE.FEATURE_ENLARGER = "KeypointRCNNFeatureEnlarger"
_C.MODEL.MEDPOSE.HEATMAP_UPSCALE = 2
_C.MODEL.MEDPOSE.STACK_LAYERS = 4
_C.MODEL.MEDPOSE.WINDOW_SIZE = 1
_C.MODEL.MEDPOSE.ROI_MAP_DIM = 14
_C.MODEL.MEDPOSE.MODEL_DIM = 256
_C.MODEL.MEDPOSE.NUM_KEYPOINTS = 17
